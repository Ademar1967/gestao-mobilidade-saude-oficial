...
def calcular_rota_otimizada_ors(origem, destinos):
    ...
    try:
        ...
        roteiro_coords = [coordenadas_latlon[0]] + [coordenadas_latlon[i] for i in ordem]
        ...
        distancia = route['features'][0]['properties']['segments'][0]['distance'] / 1000  # km
        duracao = route['features'][0]['properties']['segments'][0]['duration'] / 60  # minutos
        return {
